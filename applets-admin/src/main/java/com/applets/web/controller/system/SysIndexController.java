...
import com.applets.common.utils.CookieUtils;
...
import com.applets.framework.shiro.service.SysPasswordService;
...
public class SysIndexController extends BaseController {
    ...
    public String index(ModelMap mmap) {
        ...
        mmap.put("copyrightYear", AppletsConfig.getCopyrightYear());
        mmap.put("demoEnabled", AppletsConfig.isDemoEnabled());
        ...
        for (Cookie cookie : cookies) {
            if (StringUtils.isNotEmpty(cookie.getName())
                    && "nav-style".equalsIgnoreCase(cookie.getName())) {
    ...
    public String main(ModelMap mmap) {
        mmap.put("version", AppletsConfig.getVersion());
        return "main";
    }
