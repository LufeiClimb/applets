...
import com.applets.common.json.JSONObject;
import com.applets.common.json.JSONObject.JSONArray;
...
public class DemoFormController {
    private static final List<UserFormModel> users = new ArrayList<UserFormModel>();
    ...
    public String localRefreshTask(String fragment, String taskName, ModelMap mmap) {
        ...
        JSONObject item = new JSONObject();
        item.put(
                "name", StringUtils.defaultIfBlank(taskName, "通过电话销售过程中了解各盛市的设备仪器使用、采购情况及相关重要追踪人"));
        item.put("type", "新增");
