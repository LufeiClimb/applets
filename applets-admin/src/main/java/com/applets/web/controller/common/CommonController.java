package com.applets.web.controller.common;

import com.applets.common.config.AppletsConfig;
import com.applets.common.config.ServerConfig;
...
import com.applets.common.utils.file.FileUploadUtils;
...
public class CommonController {
    ...
    public void fileDownload(
        ...
        try {
            ...
            String filePath = AppletsConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = AppletsConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(
        ...
        try {
            ...
            // 本地资源路径
            String localPath = AppletsConfig.getProfile();
            // 数据库资源地址
            String downloadPath =
