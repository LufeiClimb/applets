package com.applets.web.controller.monitor;
...
import com.applets.common.enums.OnlineStatus;
...
public class SysUserOnlineController extends BaseController {
    ...
    @Autowired private OnlineSessionDAO onlineSessionDAO;
    ...
    @RequiresPermissions(
            value = {"monitor:online:batchForceLogout", "monitor:online:forceLogout"},
            logical = Logical.OR)
    ...
    public AjaxResult batchForceLogout(String ids) {
        for (String sessionId : Convert.toStrArray(ids)) {
            ...
            OnlineSession onlineSession =
                    (OnlineSession) onlineSessionDAO.readSession(online.getSessionId());
