...
import com.applets.system.mapper.SysUserOnlineMapper;
...
public class SysUserOnlineServiceImpl implements ISysUserOnlineService {
    ...
    public void removeUserCache(String loginName, String sessionId) {
        Cache<String, Deque<Serializable>> cache =
                ehCacheManager.getCache(ShiroConstants.SYS_USERCACHE);
    ...
    public List<SysUserOnline> selectOnlineByExpired(Date expiredDate) {
        String lastAccessTime =
                DateUtils.parseDateToStr(DateUtils.YYYY_MM_DD_HH_MM_SS, expiredDate);
