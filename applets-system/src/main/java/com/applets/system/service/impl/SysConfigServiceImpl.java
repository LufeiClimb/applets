...
import com.applets.common.utils.CacheUtils;
import com.applets.common.utils.StringUtils;
import com.applets.system.domain.SysConfig;
import com.applets.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    public void init() {
        ...
        for (SysConfig config : configsList) {
            CacheUtils.put(
                    getCacheName(), getCacheKey(config.getConfigKey()), config.getConfigValue());
        }
    }
        ...
        for (Long configId : configIds) {
            ...
            if (StringUtils.equals(UserConstants.YES, config.getConfigType())) {
                throw new BusinessException(
                        String.format("内置参数【%1$s】不能删除 ", config.getConfigKey()));
            }
        }
