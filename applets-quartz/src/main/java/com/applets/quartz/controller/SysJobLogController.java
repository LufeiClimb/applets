package com.applets.quartz.controller;
...
import com.applets.quartz.domain.SysJobLog;
import com.applets.quartz.service.ISysJobLogService;
...
public class SysJobLogController extends BaseController {
    ...
    public String jobLog(
            @RequestParam(value = "jobId", required = false) Long jobId, ModelMap mmap) {
