package com.applets.common.utils.poi;

import com.applets.common.annotation.Excel;
import com.applets.common.annotation.Excel.ColumnType;
import com.applets.common.annotation.Excel.Type;
import com.applets.common.annotation.Excels;
...
import com.applets.common.utils.DictUtils;
import com.applets.common.utils.StringUtils;
import com.applets.common.utils.file.FileTypeUtils;
import com.applets.common.utils.file.ImageUtils;
import com.applets.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (StringUtils.isNotNull(fieldType)) {
                        ...
                        if (StringUtils.isNotEmpty(attr.targetAttr())) {
                            ...
                            val =
                                    reverseDictByExp(
                                            Convert.toStr(val), attr.dictType(), attr.separator());
                        }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = AppletsConfig.getDownloadPath() + filename;
