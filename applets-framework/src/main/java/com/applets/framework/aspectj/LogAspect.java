...
import com.applets.common.enums.BusinessStatus;
import com.applets.common.json.JSON;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.applets.common.annotation.Log)")
    ...
    private void setRequestValue(SysOperLog operLog) throws Exception {
        ...
        if (StringUtils.isNotEmpty(map)) {
            PropertyPreFilters.MySimplePropertyPreFilter excludefilter =
                    new PropertyPreFilters().addFilter();
